...
[![Version](https://img.shields.io/badge/Version-1.0.14--Mondstadt-orange.svg)](#)
...
| 📦 **AIO**        | `v1-A` (Advanced) | [install-v1-A.sh](AIO/Ubuntu/install-v1-A.sh) | Custom one-click server stack installer. | [Docs 📖](AIO/Ubuntu/README.md) |
| 📦 **AIO**        | `v1-B` (Simple)   | [install-v1-B.sh](AIO/Ubuntu/install-v1-B.sh) | Direct non-interactive one-click stack installer. | [Docs 📖](AIO/Ubuntu/README.md) |
